...
class PublicUserApiTests(TestCase):
    ...
    def test_user_exists(self):
        ...
        payload = {'email': 'test@testertest.com', 'password': 'testpass'}
        create_user(**payload)
    ...
    def test_password_too_short(self):
        ...
        payload = {'email': 'test@testertest.com', 'password': 'pw'}
        res = self.client.post(CREATE_USER_URL, payload)
    ...
    def test_create_token_user(self):
        ...
        payload = {'email': 'test@tester.com', 'password': 'testpass'}
        create_user(**payload)
